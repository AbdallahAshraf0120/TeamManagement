...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wdd/teammanagement::admin.admin.index', compact('admins'));
    }
    ...
    public function add()
    {
        return view('wdd/teammanagement::admin.admin.create');
    }
    ...
    public function edit(string $id){
        ...
        return view('wdd/teammanagement::admin.admin.update',compact('admin'));
    }
