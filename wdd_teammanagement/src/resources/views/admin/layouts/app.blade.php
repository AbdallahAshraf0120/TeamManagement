...
<head>
    ...
    <link href="{{ asset('vendor/wdd_teammanagement/assets/assets/styles/main.css') }}" rel="stylesheet">
    <link href="{{ asset('vendor/wdd_teammanagement/assets/assets/icon/assets/Pe-icon-7-stroke.css') }}"
        rel="stylesheet">
...
<body>
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="assets/assets/images/avatars/1.jpg" alt="">
    ...
    <script type="text/javascript" src="{{ asset('vendor/wdd_teammanagement/assets/assets/scripts/jquery.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('vendor/wdd_teammanagement/assets/assets/scripts/main.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/wdd_teammanagement/assets/assets/scripts/app.js') }}"></script>
